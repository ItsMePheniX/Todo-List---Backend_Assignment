        ...
        <div className="mx-auto w-full max-w-md">
          ...
          <div className="mb-6 rounded-lg bg-blue-50 border-2 border-blue-200 p-4">
            <div className="flex items-start gap-2">
              <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" strokeWidth={1.5} stroke="currentColor" className="h-5 w-5 text-blue-600 mt-0.5 flex-shrink-0">
                <path strokeLinecap="round" strokeLinejoin="round" d="M11.25 11.25l.041-.02a.75.75 0 011.063.852l-.708 2.836a.75.75 0 001.063.853l.041-.021M21 12a9 9 0 11-18 0 9 9 0 0118 0zm-9-3.75h.008v.008H12V8.25z" />
              </svg>
              <div className="flex-1">
                <p className="text-sm font-semibold text-blue-900 mb-2">Admin Login Credentials</p>
                <div className="space-y-1 text-xs text-blue-800 font-mono bg-white rounded px-3 py-2 border border-blue-100">
                  <p><span className="font-semibold">Email:</span> aadityaa5000@gmail.com</p>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            ...
            <button
              type="submit"
              disabled={loading}
              className="flex w-full items-center justify-center rounded-lg bg-blue-600 py-4 text-sm font-semibold text-white shadow-lg hover:shadow-xl transition-all hover:bg-blue-700 hover:-translate-y-0.5 disabled:opacity-50 disabled:hover:translate-y-0"
            >
